...
export default function Start() {
  ...
  return (
    <div className="bg-gradient-to-tr from-teal-400 to-yellow-200 w-screen h-screen flex justify-center items-center p-4">
      <div className="bg-white w-full sm:w-1/2 h-2/3 flex rounded-2xl flex-col shadow-xl">
